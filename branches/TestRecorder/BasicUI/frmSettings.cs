...
namespace TestRecorder
{
    public partial class frmSettings : Form
    {
        ...
        public void ObjectToGUI(AppSettings settings)
        {
            ...
            chkSetSize.Checked = settings.SetMaxSize;
            cbWaitTime.Text = settings.GlobalWaitTime.ToString();
        ...
        public void GUIToObject(AppSettings settings)
        {
            ...
            settings.SetMaxSize = chkSetSize.Checked;
            settings.GlobalWaitTime = int.Parse(cbWaitTime.Text);
            ...
            settings.documentPath = Application.StartupPath + "\\settings.xml";
