...
namespace TestRecorder
{
    public partial class frmDocInfo : Form
    {
        ...
        {
            Icon = FormHelper.BitmapToIcon(34);
        }
        ...
        public void LoadDocumentInfo(csExWB.cEXWB pWB)
        {
            ...
            var doc2 = (IHTMLDocument2)pWB.WebbrowserObject.Document;
            ...
            var elems = (IHTMLElementCollection)doc2.images;
        ...
        private void saveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                FormHelper.FrmLog.AppendToLog("frmDocInfo::saveToolStripMenuItem_Click\r\n" + ee);
            }
        }
        ...
        private void saveAsXMLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FormHelper.ShowStaticSaveDialogForXML(this) == DialogResult.OK)
                {
                    var savetree = new TreeViewSerializer();
                    savetree.SerializeTreeView(treeDocInfo, FormHelper.DlgSave.FileName);
                }
            }
            catch (Exception ee)
            {
                FormHelper.FrmLog.AppendToLog("frmDocInfo::saveAsXMLToolStripMenuItem_Click\r\n" + ee);
            }
        }
        ...
        private void treeDocInfo_NodeMouseClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            {
                FormHelper.FrmLog.AppendToLog("treeDocInfo_NodeMouseClick\r\n" + ee);
            }
        }
